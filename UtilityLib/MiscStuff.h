...
extern void	Misc_InterleaveVec4IdxToF16(const vec4 vec0, const vec3 vec1, uint16_t idx, uint32_t *pDest);
extern void	Misc_InterleaveBone(const vec4 weights, const uint8_t indexes[4], uint16_t idx, uint32_t *pDest);
